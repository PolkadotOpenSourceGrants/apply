...
**Team Interest:**
We aim to create a unified benchmarking toolkit that helps developers, researchers, and ecosystem stakeholders evaluate ink!’s performance benefits with reproducible, transparent data.
...
- Website:  https://github.com/MeshPort-Labs
...
- https://www.linkedin.com/in/mohan-kumar-iitbhu/
...
I have 3 years of experience in Full Stack Development, working as an AI Engineer and Software Development. 

I have participated in many hackathons and some web3 hackathons, also winning some of them. I have also contributed to a lot of open Source Projects(Like [AsyncAPI](https://github.com/asyncapi), [Floresta](https://github.com/vinteumorg/Floresta))  

Currently this is the [POC](https://github.com/ItshMoh/inkBench) that i am working on.

---

## Development Status :open_book:

* [PoC](https://github.com/ItshMoh/inkBench) cli implemented where we have a CLI to deploy, call, and benchmark contracts.
...
| --- | ---- | --- | --- | --- | ---|
| Personell | Rust Backend Developer | 7,500 USD | 1.5 FTE | 11,250 USD | Core library, pallet-revive integration, contract compilation, benchmarking logic |
| Personell | Documentation & Testing| 2,500 USD | 0.5 FTE | 1,250 USD | Technical documentation, unit/integration tests, benchmark validation  |
| Infrastructure | Testing & Development | 2,500 USD | | 2,500 USD | CI/CD pipelines, Docker setup, cloud test environments  |
| --- | --- | --- | **Total** | **15,000 USD** |  |

For the Milestone 2
| Category | Item | Cost | Amount | Total | Description |
| --- | ---- | --- | --- | --- | ---|
| Personell | Full-Stack Developer | 7,500 USD | 1.5 FTE | 11,250 USD | Web API service, Next.js frontend, data visualization, deployment |
| Personell | Rust Backend Developer| 2,500 USD | 0.5 FTE | 1,250 USD | Upgradeable contracts, ABI efficiency benchmarks, API integration  |
| Personell | Documentation| 2,000 USD | 0.5 FTE | 1,000 USD | Tutorial articles, user guides, API documentation  |
| Infrastructure | Hosting & Services | 1,500 USD | | 1,500 USD | Web hosting, domain/SSL, cloud services  |
| --- | --- | --- | **Total** | **15,000 USD** |  |
## Future Plans
